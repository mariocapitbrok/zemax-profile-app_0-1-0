...
export default function LicenseTableBase ( { adaptedLicensesData, rows, handleSort, handlePagination, page, maxPages, handleViewAll } ) {
		...
		return (
			<>
				<DataTable title="Tile"
						   ...
						   onSort={handleSort}
				/>
				<Paginator page={page} maxPages={maxPages} handlePagination={handlePagination} handleViewAll={handleViewAll} />
			</>
		)
	}
